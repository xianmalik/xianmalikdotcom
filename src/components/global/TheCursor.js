  ...
  return (
    <>
      <span
				...
				className="fixed top-0 left-0 h-8 w-8 border-2 border-white opacity-25 border-opacity-75 rounded-full -translate-x-1/2 -translate-y-1/2 transform z-50 transition-all duration-200 ease-out pointer-events-none"
			></span>
			<span
