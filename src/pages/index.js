		...
		<Base>
			<section className="h-screen w-full grid grid-cols-2 max-w-screen-2xl mx-auto items-center p-8" id="me">
				<div className="text-left mx-auto p-8 max-w-5xl">
					...
					<Divider />
					<h4 className="text-lg tracking-wide text-gray-400 mb-4 pt-2">Front-End Developer with an undying <span role="img" aria-label="Heart">❤</span> for JavaScript & Coffee <span role="img" aria-label="Coffee">☕</span></h4>
					<Button>
						PROJECTS
					</Button>
